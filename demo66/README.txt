...
a persistence unit "demo66PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demo66/pom.xml":
...
artifact ("demo66.war") is already built. You can build
